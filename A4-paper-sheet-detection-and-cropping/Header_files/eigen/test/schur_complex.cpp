...
template<typename MatrixType> void schur(int size = MatrixType::ColsAtCompileTime)
{
  ...
  VERIFY_IS_EQUAL(cs1.info(), MySuccess);
  VERIFY_IS_EQUAL(cs2.info(), MySuccess);
  ...
  VERIFY_IS_EQUAL(csOnlyT.info(), MySuccess);
